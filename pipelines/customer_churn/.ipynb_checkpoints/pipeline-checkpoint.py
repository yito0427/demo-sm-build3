...
def get_pipeline(
    ...
    input_data = ParameterString(
        name="InputDataUrl",
        default_value=f"s3://sagemaker-ap-northeast-1-315303706658/sagemaker/DEMO-xgboost-churn/data/RawData.csv",  # Change this to point to the s3 location of your raw input data.
    )
